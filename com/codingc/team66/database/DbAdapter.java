...
abstract public class DbAdapter {
	...
	protected static ZomatoDatabaseHelper dbHelper;
	protected String dbName = "dBProfile";
	...
	final public static void open(Context context) throws SQLException {
		dbHelper = new ZomatoDatabaseHelper(context);
		try {
			db = dbHelper.getWritableDatabase();
		} catch (SQLiteException e) {
			Log.w("Zomato","ProjectsDbAdapter::getWritableDatabase error: " + e.getMessage());
		}
	}
